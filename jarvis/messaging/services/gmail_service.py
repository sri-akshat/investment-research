"""Gmail service implementation for fetching messages with attachments."""
...
class GmailService(MessageService):
    """Message service that sources data from Gmail."""
    ...
    def search(self, query: str) -> Iterable[Message]:
        ...
        except HttpError as exc:  # pragma: no cover - network error surface
    ...
    def _get_message(self, message_id: str) -> Message:
        ...
        recipients = [h.strip() for h in headers.get("to", "").split(",") if h.strip()]
